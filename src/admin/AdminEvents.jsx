...
const AdminEvents = () => {
  ...
  const [form, setForm] = useState({
    ...
    gform_link: "", registration_open: false
  });
  ...
  const submit = async () => {
    ...
    setForm({ title:"", categories:"", details:"", gform_link:"", registration_open:false });
    setEditId(null);
    load();
  };
  ...
  return (
    <div className="admin-box">
      ...
      <input placeholder="Google Form Link"
      ...
      <ul>
        {events.map(e => (
          <li key={e.id}>
            {e.title}
            <button onClick={()=>{setEditId(e.id);setForm(e);}}>Edit</button>
